<x-layout>
    ...
    <div class="conteiner vh-100 bg-custom2">
        <div class="row justify-content-center">
            <div class="col-12">
                <h1 class="text-center display-1 title-custom">Registrati</h1>
            </div>
            <div class="col-6">
                <form action="/register" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="name" class="form-label label-custom">Nome Utente</label>
                    ...
                    <div class="mb-3">
                        <label for="password_confirmation" class="form-label label-custom">Conferma Password</label>
